...
public class OrderPreservingProperties implements Map<String, String> {
    ...
    public void load(InputStream is) {
        ...
        Map<String, String> properties = toMapProps(string);
        putAll(properties);
    }
    ...
    protected static String[] splitKeyValue(String keyValueLine) {
        ...
        buildKey(line, keyBuffer, valueBuffer);
    ...
    private static void buildKey(String line, StringBuilder keyBuffer, StringBuilder valueBuffer) {
